...
exports.insert = async (data) => {
    const { room_id, user_name, phone, date_reservation, time_reservation, occasion, intolerances, status } = data;
    const sql = `
    INSERT INTO reservations
    (room_id, user_name, phone, date_reservation, time_reservation, occasion, intolerances, status)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `;
    const params = [room_id, user_name, phone, date_reservation, time_reservation, occasion, intolerances, status || 'pending'];
...
exports.update = async (id, data) => {
    ...
    WHERE id=?
  `;
    const params = [room_id, user_name, phone, date_reservation, time_reservation, occasion, intolerances, status, id];
